...
const ClimbingHills = ({navigation}) => {
  return (
     ...
     <View style={[{
       ...
       <View style={{flexDirection:'row'}}>
          <View style={styles.Shadow}>
            <Image source={images.Frozenhill}
              resizeMode="cover"
            ...
            <View style={{marginHorizontal: SIZES.radius, justifyContent: 'space-around'}}>
                <Text style={{...FONTS.h3, color: COLORS.black}}>Shang woo</Text>
                <Text style={{color: COLORS.gray, ...FONTS.Body3}}>China</Text>
